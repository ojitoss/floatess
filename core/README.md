...
- ```DigitsStream```: The main trait of the create, they path is: ```floatess::DigitsStream```. this trait had two main requerimients, a way to get a length of digits, and a way to acces to a specific digit in the stream, example: '12345', had length of 5 and digits 0 is '1' (the acces starts from 0 like array).
...
### Basic
*Struct firm: digits_storage::basic::Storage(&[u8])*  
...
### Small
*Struct firm: digits_storage::small::Storage<T>(T)*  
...
### Whitout
*Struct firm: digits_storage::whitout::Storage*    
